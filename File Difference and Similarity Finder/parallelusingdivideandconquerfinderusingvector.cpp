...
void getSameDiff(vector<string> filec1,long long int &dif1,vector<string> filec2,long long int &dif2,vector<Line> &difffile1,vector<Line> &difffile2,vector<Line> &same,long long int start,long long int end)
{
	...
	else
	{
		...
		dif1=diff11+diff12;
		dif2=diff21+diff22;
		difffile1.insert( difffile1.end(), differfile11.begin(), differfile11.end() );
		difffile1.insert( difffile1.end(), differfile12.begin(), differfile12.end() );
		difffile2.insert( difffile2.end(), differfile21.begin(), differfile21.end() );
		difffile2.insert( difffile2.end(), differfile22.begin(), differfile22.end() );
		same.insert( same.end(), same1.begin(), same1.end() );
		same.insert( same.end(), same2.begin(), same2.end() );
		same.insert( same.end(), same3.begin(), same3.end() );
		same.insert( same.end(), same4.begin(), same4.end() );
